...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'application' | 'company' | 'employee' | 'hr_manager' | 'job' | 'user';
  ...
  interface applicationFieldRefs {
    ...
    readonly applied_date: FieldRef<'application', 'DateTime'>;
  ...
  interface hr_managerFieldRefs {
    ...
    readonly status: FieldRef<'hr_manager', 'String'>;
  ...
  export type applicationWhereInput = {
    ...
    applied_date?: DateTimeFilter<'application'> | Date | string;
  ...
  export type applicationScalarWhereWithAggregatesInput = {
    ...
    applied_date?: DateTimeWithAggregatesFilter<'application'> | Date | string;
  ...
  export type hr_managerWhereInput = {
    ...
    status?: StringNullableFilter<'hr_manager'> | string | null;
  ...
  export type hr_managerScalarWhereWithAggregatesInput = {
    ...
    status?: StringNullableWithAggregatesFilter<'hr_manager'> | string | null;
