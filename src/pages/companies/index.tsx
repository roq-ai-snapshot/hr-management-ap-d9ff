  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: [, 'hr_manager.count', 'job.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: ['description.contains', 'industry.contains', 'website.contains', 'name.contains'],
          ...params.filters,
        },
        'company',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'description', header: 'Description', accessorKey: 'description' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.founded_date ? format(record?.founded_date, 'dd-MM-yyyy') : '',
    },
