    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="founded_date" mb="4">
            <FormLabel fontSize="1rem" fontWeight={600}>
              Founded Date
            </FormLabel>
            <DatePicker
              selected={formik.values?.founded_date ? new Date(formik.values?.founded_date) : null}
              onChange={(value: Date) => formik.setFieldValue('founded_date', value)}
            />
          </FormControl>
