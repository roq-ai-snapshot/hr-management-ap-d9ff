      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['status.contains', 'resume.contains', 'cover_letter.contains'],
          ...params.filters,
        },
        'application',
      ),
  ...
  const columns: ColumnType[] = [
    { id: 'status', header: 'Status', accessorKey: 'status' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.applied_date ? format(record?.applied_date, 'dd-MM-yyyy') : '',
    },
    { id: 'resume', header: 'Resume', accessorKey: 'resume' },
    { id: 'cover_letter', header: 'Cover Letter', accessorKey: 'cover_letter' },
